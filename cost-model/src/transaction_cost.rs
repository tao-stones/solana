...
mod tests {
    ...
    fn test_vote_transaction_cost() {
        ...
        // expected non-vote tx cost would include default loaded accounts size cost (16384) additionally, and 200_000 for instruction
        let expected_none_vote_cost = 218435;
